...
from knowledge_graph.ark_client import ArkAuthenticationError, ArkClientError
from knowledge_graph.graph_pipeline import run_graph_pipeline
from knowledge_graph.llm_request_pool import LLMRequestPool
from knowledge_graph.pipeline.artifact_store import cleanup_saved_upload_batch, cleanup_stale_runtime_files, prune_run_directories
from knowledge_graph.ollama_client import OllamaClientError
from knowledge_graph.pipeline.types import JobStage, JobStatus, ProgressEvent, SavedUploadBatch
...
class JobManager:
    ...
    def _build_result_payload(result: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "graph_url": f"/runs/{run_id}/graph.html",
            "standalone_graph_url": f"/runs/{run_id}/graph_standalone.html",
            "chunks_csv_url": f"/runs/{run_id}/chunks.csv",
            "graph_csv_url": f"/runs/{run_id}/graph.csv",
            "grouped_graph_csv_url": f"/runs/{run_id}/graph_grouped.csv",
            "metadata_url": f"/runs/{run_id}/metadata.json",
            "metadata": metadata,
        }
